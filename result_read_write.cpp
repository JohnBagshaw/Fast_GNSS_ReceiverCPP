...
void compareTrackingResults(TrackResults_t* trackResults,IsMatEqualTrackResults_t* isMatEqualTrackResults,const Settings_t* settings)
{
...
void saveResults(AcqResults_t* acqResults,TrackResults_t* trackResults,const Settings_t* settings,bool disableTrackResultSave)
{
  MATFile* pmat;
  //settings->fileName
